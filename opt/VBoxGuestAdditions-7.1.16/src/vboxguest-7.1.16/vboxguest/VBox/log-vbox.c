/* $Id: log-vbox.cpp 164827 2024-09-16 14:03:52Z bird $ */
/** @file
...
# endif
    ...
    ASSERT_LOG_GROUP(IEM_RE_NATIVE);
    ASSERT_LOG_GROUP(IEM_RE_THREADED);
    ASSERT_LOG_GROUP(IEM_SVM);
    ASSERT_LOG_GROUP(IEM_VMX);
    ...
    ASSERT_LOG_GROUP(MAIN_FIRMWARESETTINGS);

...
# Build environment
grub_target_cc='cc'
grub_target_cc_version='cc (Ubuntu 15.2.0-14ubuntu1) 15.2.0'
...
grub_target_cppflags='-Wno-unused-but-set-variable -Wall -W  -DGRUB_MACHINE_PCBIOS=1 -DGRUB_MACHINE=I386_PC -m32 -nostdinc -isystem /usr/lib/gcc/x86_64-linux-gnu/15/include -I$(top_srcdir)/include -I$(top_builddir)/include'
...
grub_version="2.14"
grub_package="grub"
grub_package_string="GRUB 2.14-2ubuntu2"
grub_package_version="2.14-2ubuntu2"
